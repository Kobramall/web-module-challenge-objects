...
function createMenuItem(object, cost, meal){
  object = {name:object, price:cost, category: meal,}
  return object
}

console.log('task 1a:',createMenuItem('latte', '4', 'drinks'));
...
console.log('task 5:', addReview(reviews, 'John', '8', 'It was good.'));
